    ...
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[1000px] mx-auto mt-[2rem]">
        ...
        <div>
          ...
          <p className="text-[1.2rem] pl-[1rem]">3. The prize is one gift card to the local Edmonds shop, Crow, for the amount of $50 as well as assorted goods from attending vendors.</p>
