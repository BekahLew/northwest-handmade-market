...
export default async function Page() {
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[2000px] mx-auto mt-[2rem]">
        ...
        <Link href="/our-vendors/july/casi-g-designs" className={styles.vendor + " bg-[#fff]"}>
          <Image
        ...
        <Link href="/our-vendors/july/the-forest-blues" className={styles.vendor + " bg-[#fff]"}>
          <Image
        ...
        <Link href="/our-vendors/july/way-cool-stuff" className={styles.vendor + " bg-[#fff]"}>
          <Image
        ...
        <Link href="/our-vendors/july/love-and-flora-creations" className={styles.vendor + " bg-[#fff]"}>
          <Image
        ...
        <Link href="/our-vendors/july/dw-crafts" className={styles.vendor + " bg-[#fff]"}>
          <Image
        ...
        <Link href="/our-vendors/july/full-bloom-and-co" className={styles.vendor + " bg-[#fff]"}>
          <Image
        ...
        <Link href="/our-vendors/july/elevar-sundry-company" className={styles.vendor + " bg-[#fff]"}>
            <Image
        ...
        <Link href="/our-vendors/july/adrianas-bowtique" className={styles.vendor + " bg-[#fff]"}>
          <Image
        ...
        <Link href="/our-vendors/july/sugarcane-beauty" className={styles.vendor + " bg-[#fff]"}>
          ...
          <Link href="/our-vendors/july/wanderlust-scents-studio" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/rustic-designs" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/handslow-pottery" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/colorful-discoveries" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/red-sunset-designs" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/hae-candles" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/corina-kay-designs" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/coco-crafts" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/july/oddpetz-emporium" className={styles.vendor + " bg-[#fff]"}>
            <Image
