    ...
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[2000px] mx-auto mt-[2rem]">
        ...
        <div className={styles.vendors}>
          <Link href="/our-vendors/august/the-forest-blues" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/cards-by-meesh" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/faerie-made" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/from-my-art" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/leslie-sarah-designs" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/long-play-art" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/love-my-resin" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/naterade-creates" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/hae-candles" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/dw-crafts" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/koala-creations" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/doily-by-pony" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/elevar-sundry-company" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/linked-with-joy" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/red-sunset-designs" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/vs-treats-bakery" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/sand-dollar-style" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/trinda-magic" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/crafty-juniper" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/coco-crafts" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/august/aromatic-creations" className={styles.vendor + " bg-[#fff]"}>
            <Image
