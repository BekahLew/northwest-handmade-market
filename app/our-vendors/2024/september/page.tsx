    ...
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[2000px] mx-auto mt-[2rem]">
        ...
        <div className={styles.vendors}>
          <Link href="/our-vendors/loving-home-crochet" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/loopsalooza" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/my-wandering-muse" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/sugarcane-beauty" className={styles.vendor + " bg-[#fff]"}>
            <Image
