    ...
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[2000px] mx-auto mt-[2rem]">
        ...
        <div className={styles.vendors}>
          <Link href="/our-vendors/september/loving-home-crochet" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/pilchuck-soap-company" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/loopsalooza" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/elevar-sundry-company" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/my-wandering-muse" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/koala-creations" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/cards-by-meesh" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/coco-crafts" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/corina-kay-designs" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/gemini-gems-ak" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/plantern-glass-and-novelty" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/shiki-clay" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/way-cool-stuff" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/sugarcane-beauty" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/september/the-forest-blues" className={styles.vendor + " bg-[#fff]"}>
            <Image
