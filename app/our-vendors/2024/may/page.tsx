    ...
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[1600px] mx-auto mt-[2rem]">
        ...
        <div className={styles.vendors}>
          <Link href="/our-vendors/wanderlust-scents-studio" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/rustic-designs" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/writers-coop" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/sweet-katies-treats" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/amigurumis" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/inti-the-label" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/soha365" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/babaubles" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/zarqa-makes" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/bonafide-pets" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/earrings-by-e" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/tyche-handcrafted" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/moore-than-stitches" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/m-and-ms-vintage-crafts" className={styles.vendor + " bg-[#b45537]"}>
              <Image
