    ...
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[2000px] mx-auto mt-[2rem]">
        ...
        <div className={styles.vendors}>
          <Link href="/our-vendors/june/tyche-handcrafted" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/june/corina-kay-designs" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/june/soha365" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/june/gemini-gems-ak" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/june/handslow-pottery" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/june/wanderlust-scents-studio" className={styles.vendor + " bg-[#fff]"}>
            <Image
          ...
          <Link href="/our-vendors/june/oddpetz-emporium" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/colorful-discoveries" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/marisi-ceramics" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/trinda-magic" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/routea" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/crafty-juniper" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/red-sunset-designs" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/aromatic-creations" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/plantern-glass-and-novelty" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/tickle-my-sweets" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/vs-treats-bakery" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/linked-with-joy" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/mca-creations" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/shiki-clay" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/birdcraft-studio" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/june/taylors-creative-nook" className={styles.vendor + " bg-[#fff]"}>
              <Image
