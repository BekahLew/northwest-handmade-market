    ...
    return (
      <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[2000px] mx-auto mt-[2rem]">
        ...
        <div className={styles.vendors}>
          ...
          <Link href="/our-vendors/oddpetz-emporium" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/colorful-discoveries" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/marisi-ceramics" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/routea" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/plantern-glass-and-novelty" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/tickle-my-sweets" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/mca-creations" className={styles.vendor + " bg-[#fff]"}>
              <Image
            ...
            <Link href="/our-vendors/birdcraft-studio" className={styles.vendor + " bg-[#fff]"}>
              <Image
