    ...
    <div className="pr-[1rem] pl-[1rem] sm:pr-20 sm:pl-20 max-w-[2000px] mx-auto mt-[2rem]">
      ...
      <div className={styles.vendor}>
        <div className={styles.vendorInfo}>
          <Image
            src="/images/vendors/crafty-juniper/crafty-juniper-4.png"
            height={200}
            width={200}
        ...
        <div>
          <Slider
            imgSrc1={"/images/vendors/crafty-juniper/crafty-juniper-3.png"}
            img1Alt={"Handmade bags by Craft Juniper"}
            imgSrc2={"/images/vendors/crafty-juniper/crafty-juniper-2.png"}
            img2Alt={"Handmade bags by Craft Juniper"}
            imgSrc3={"/images/vendors/crafty-juniper/crafty-juniper-1.jpg"}
            img3Alt={"Handmade bags by Craft Juniper"}
            imgSrc4={"/images/vendors/crafty-juniper/crafty-juniper-4.png"}
            img4Alt={"Handmade bags by Craft Juniper"}
            imgSrc5={"/images/vendors/crafty-juniper/crafty-juniper-5.png"}
            img5Alt={"Handmade bags by Craft Juniper"}
            imgSrc6={"/images/vendors/crafty-juniper/crafty-juniper-6.png"}
            img6Alt={"Handmade bags by Craft Juniper"}
            imgSrc7={"/images/vendors/crafty-juniper/crafty-juniper-7.jpg"}
            img7Alt={"Handmade bags by Craft Juniper"}
            imgSrc8={"/images/vendors/crafty-juniper/crafty-juniper-8.jpg"}
            img8Alt={"Handmade bags by Craft Juniper"}
            imgSrc9={"/images/vendors/crafty-juniper/crafty-juniper-9.jpg"}
